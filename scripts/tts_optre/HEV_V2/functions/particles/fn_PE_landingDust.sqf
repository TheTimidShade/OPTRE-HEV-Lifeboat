...
_particle setParticleRandom [
	...
	[0.5, 0.5, 0.5], //Position variance
	[0.5, 0.5, 0.2], //Velocity variance
...
_particle setParticleParams [
	...
	*/
	...
	0, //Wind influence
	[2, 4, 5], //Particles sizes (particles seem to change size over time)
