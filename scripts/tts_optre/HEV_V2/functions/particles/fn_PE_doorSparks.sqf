/**
	...
	***MODIFIED***
	...
	Description:
	DOOR BOLT SPARKS FOR HEV SCRIPT
...
_particle setParticleParams [
	...
	*/
	...
	0, //Wind influence
	[2,1,0], //Particles sizes (particles seem to change size over time)
...
_particle_2 setDropInterval 0.005;

_particle attachTo [_sourceObj, [0.6,0.4,0.5]];
